...
export default function Header() {
    ...
    return (
        <header className="h-10 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 flex items-center justify-between sticky top-0 z-50 transition-colors">
            {/* Left: Logo & Search */}
