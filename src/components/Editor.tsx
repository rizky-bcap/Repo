...
export const MenuBar = ({ editor }: { editor: any }) => {
    ...
    return (
        <div className="flex items-center gap-1 border-b border-gray-200 dark:border-gray-800 p-2 bg-white dark:bg-gray-900 sticky top-0 z-10 flex-wrap h-9 scrollbar-hide overflow-x-auto">
            <select
                className="h-7 px-2 border border-gray-200 dark:border-gray-800 rounded text-[11px] bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 focus:outline-none"
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('bold') ? 'bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-100' : 'text-gray-600 dark:text-gray-400')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('italic') ? 'bg-gray-200' : '')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('heading', { level: 1 }) ? 'bg-gray-200' : '')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('heading', { level: 2 }) ? 'bg-gray-200' : '')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('bulletList') ? 'bg-gray-200' : '')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('orderedList') ? 'bg-gray-200' : '')}
            >
            ...
            <Button
                ...
                className={cn("h-7 w-7", editor.isActive('blockquote') ? 'bg-gray-200' : '')}
            >
